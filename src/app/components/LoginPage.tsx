...
export function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setIsLoading(false);
    navigate(result.role === "customer_support" ? "/support" : "/dashboard");
  };
  ...
  return (
    <div className="min-h-screen w-full flex" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div
        ...
        style={{ background: "linear-gradient(160deg, #2dd4bf 0%, #0d9488 60%, #0f766e 100%)" }}
      >
        {/* Decorative blobs */}
        ...
        <div className="w-full" style={{ maxWidth: "400px" }}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{
                    ...
                    color: "#0f172a", fontSize: "0.875rem", boxShadow: "0 1px 3px rgba(0,0,0,0.04)",
                  }}
                  onFocus={e => { e.target.style.border = "1.5px solid #0d9488"; e.target.style.boxShadow = "0 0 0 3px rgba(13,148,136,0.1)"; }}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-3 outline-none transition-all duration-200"
                  style={{
                    background: "white", border: "1.5px solid #e2e8f0", borderRadius: "12px",
                    color: "#0f172a", fontSize: "0.875rem", boxShadow: "0 1px 3px rgba(0,0,0,0.04)",
                  }}
            ...
            <div className="flex justify-end -mt-1">
              <Link
                to="/forgot-password"
                style={{ color: "#0d9488", fontWeight: 500, fontSize: "0.8rem", textDecoration: "none" }}
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "12px", color: "white", fontWeight: 600, fontSize: "0.95rem",
